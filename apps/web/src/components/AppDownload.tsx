    ...
    <section id="player-waitlist" className={styles.section} aria-labelledby="waitlist-heading">
      <div className={`container ${styles.grid}`}>
        ...
        <div className={styles.formWrap}>
          {status === "done" ? <div className={styles.success} role="status" aria-live="polite"><span aria-hidden="true">Done</span><div><b>You’re on the list.</b><p>We’ll email you when player access opens.</p></div></div> :
