...
export function PwaInstallBanner() {
  ...
  const styles = StyleSheet.create({
    banner: {
      ...
      borderWidth: 1,
      borderColor: semantic.actionContainer,
    },
  ...
  return (
    <View style={styles.banner}>
      <MaterialIcons name="install-mobile" size={22} color={semantic.action} />
      ...
      <TouchableOpacity onPress={onInstall} hitSlop={8} style={styles.iconButton}>
        <MaterialIcons name="download" size={22} color={semantic.action} />
      </TouchableOpacity>
    </View>
  );
}